				...
				<ul id="full-image-slider">
					<li class="item">
						<div class="image-entry">
							...
							<img src="img/tranquil-outdoor-cafe/garden.jpg" alt="">
						</div>
					</li>
		...
		<div class="container">
			...
			<div class="row">
				...
				<p class="full-width-text">
					Garden Cafe - Tranquil Outdoor Cafe
				</p>
			...
			<div class="row">
				...
				<div class="col-xs-12">
					...
					<div class="classic-nav opacity">
						...
						<div class="side-nav">
							<a class="prev" href="hight-street-retail.php"></a>
							<a class="central" href="works.php"></a>
							<a class="next" href="daughters-pride.php"></a>
						</div>
