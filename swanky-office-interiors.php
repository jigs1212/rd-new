				...
				<ul id="full-image-slider">
					<li class="item">
						<div class="image-entry">
							...
							<img src="img/swanky-office-interiors/taj.jpg" alt="">
						</div>
					</li>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-xs-12">
						<div class="section-title type-2 opacity">
							<h3>TAJ SOUTH REGIONAL OFFICE</h3>
						</div>
					</div>
				...
				<div class="row">
					...
					<p class="full-width-text">
						Taj South - Swanky Office Interiors
					</p>
				...
				<div class="row">
					...
					<div class="col-xs-12">
						...
						<div class="classic-nav opacity">
							...
							<div class="side-nav">
								<a class="prev" href="endeavour.php"></a>
								<a class="central" href="works.php"></a>
								<a class="next" href="swanky-office-interiors.php"></a>
							</div>
