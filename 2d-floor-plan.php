				...
				<ul id="full-image-slider">
					<li class="item">
						<div class="image-entry">
							...
							<img src="img/2d-floor-plan/2d.jpg" alt="">
						</div>
					</li>
					<li class="item">
						<div class="image-entry">
							<img src="img/2d-floor-plan/2d-2.jpg" alt="">
						</div>
					</li>
		...
		<div class="container">
			...
			<div class="row">
				...
				<p class="full-width-text">
					2D Floor Plans - Comprehensive 2D Floor Plans
				</p>
			...
			<div class="row">
				...
				<div class="col-xs-12">
					...
					<div class="classic-nav opacity">
						...
						<div class="side-nav">
							<a class="prev" href="3d-floor-plan.php"></a>
