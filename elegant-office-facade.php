				...
				<ul id="full-image-slider">
					<li class="item">
						<div class="image-entry">
							...
							<img src="img/elegant-office-facade/hdfc.jpg" alt="">
						</div>
					</li>
		...
		<div class="container">
			...
			<div class="row">
				...
				<p class="full-width-text">
					HDFC Ergo -  Elegant Office Facade
				</p>
			...
			<div class="row">
				...
				<div class="col-xs-12">
					...
					<div class="classic-nav opacity">
						...
						<div class="side-nav">
							<a class="prev" href="daughters-pride.php"></a>
							<a class="central" href="works.php"></a>
							<a class="next" href="plush-residential-interiors.php"></a>
						</div>
